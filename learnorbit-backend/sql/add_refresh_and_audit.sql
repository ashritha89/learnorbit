-- sql/migrations/20260207_add_refresh_and_audit.sql
-- 1. Add columns to admin_users for lockout and failed attempts
ALTER TABLE admin_users
  ADD COLUMN failed_login_attempts INT NOT NULL DEFAULT 0,
  ADD COLUMN lock_until DATETIME NULL;

-- 2. Create refresh_tokens table (opaque token, one‑time use)
